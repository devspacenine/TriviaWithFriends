...
exports.file = input('image');
exports.file = input('color');
exports.file = input('date');
exports.file = input('datetime');
exports.file = input('datetime-local');
exports.file = input('email');
exports.file = input('month');
exports.file = input('number');
exports.file = input('range');
exports.file = input('search');
exports.file = input('tel');
exports.file = input('time');
exports.file = input('url');
exports.file = input('week');
